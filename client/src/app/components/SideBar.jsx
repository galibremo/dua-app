...
export default function SideBar() {
  return (
    <div className="max-w-[150px] h-[95vh] flex flex-col items-center justify-between p-5 bg-white rounded-3xl">
      <div>
        <img
      ...
      <div className="flex flex-col items-center gap-3">
        <div className="rounded-full bg-slate-100 w-[50px] h-[50px] flex items-center justify-center">
          <img src="https://duaruqyah.com/assets/nav/home.svg" alt="" />
        </div>
        <div className="rounded-full bg-slate-100 w-[50px] h-[50px] flex items-center justify-center">
          <img src="https://duaruqyah.com/assets/nav/alldua.svg" alt="" />
        </div>
        <div className="rounded-full bg-slate-100 w-[50px] h-[50px] flex items-center justify-center">
          <img src="https://duaruqyah.com/assets/nav/memorize.svg" alt="" />
        </div>
        <div className="rounded-full bg-slate-100 w-[50px] h-[50px] flex items-center justify-center">
          <img src="https://duaruqyah.com/assets/nav/bookmark.svg" alt="" />
        </div>
        <div className="rounded-full bg-slate-100 w-[50px] h-[50px] flex items-center justify-center">
          <img src="https://duaruqyah.com/assets/nav/ruqyah.svg" alt="" />
        </div>
        <div className="rounded-full bg-slate-100 w-[50px] h-[50px] flex items-center justify-center">
          <img src="https://duaruqyah.com/assets/nav/dua-info.svg" alt="" />
        </div>
        <div className="rounded-full bg-slate-100 w-[50px] h-[50px] flex items-center justify-center">
          <img src="https://duaruqyah.com/assets/nav/books.svg" alt="" />
        </div>
      </div>

      <div className="w-12 h-12 bg-[#1FA45B] rounded-lg flex items-center justify-center">
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
